...
- 英雄培养界面重构为“左侧英雄名单 + 中央英雄与战力 + 右侧养成”的三栏结构，桌面弹窗和手机单层滚动布局共用“等级 / 车辆 / 枪械”三个清晰页签；整体层级参考生存策略游戏的英雄页信息密度，但视觉、人物和装备图形均为本项目原创工业风 CSS 表现。
...
- 点击“英雄”或玩家头像：进入三栏英雄培养页；选择英雄后可升级等级、改配已解锁车辆和枪械、为当前车辆安装/升级/卸下四类配件、回收闲置配件，以及消耗零件强化枪械。
