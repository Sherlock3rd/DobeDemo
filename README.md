...
- 三车道自动前进：点按 `↑/↓`、`W/S` 或触屏方向按钮换道，长按方向进入物理漂移并补充氮气；空中继续按方向可完成翻滚特技，空格/触屏“加速”消耗氮气，追击关使用 `F`/触屏“开火”。
- 竞速关为四车同场。每辆车都有独立质量、速度、横向惯性、偏航、耐久与悬挂参数；前后追撞会按质量与相对速度交换动量，后车减速、前车受推加速，氮气冲撞还会产生额外破坏。
- 公路包含可见路障与上扬跳台；车辆能真实腾空、翻滚、落地，成功特技补充氮气，失败落地会损失速度与耐久。跟随同车道前车可获得尾流加速。
- 追击关由装甲目标车和两辆护卫车组成移动队形。护卫会主动封锁射界；玩家需要换道、突破或摧毁护卫，再以具有飞行时间的可见弹道攻击目标。枪口焰、曳光弹、命中火花、碎片、烟雾、爆炸、后坐与车辆受力共同提供射击反馈。
